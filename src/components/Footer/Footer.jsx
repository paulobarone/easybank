import { Button, Container, Link } from "../../styles/Components.style";
import { List, ListLinksContainer } from './Footer.style';
    ...
    <Container className="footerContainer">
      <div className="firstPart">
        <div className="columnContainer">
          <Logo white={true} />
          <List>
            <a className="socialMediaImg" href='/'>
      ...
      <div className="columnContainer">
        ...
        <div>
          ...
          <Paragraph className="footer">Developed by <Link href="https://github.com/paulobarone">Paulo Barone</Link>.</Paragraph>
        </div>
      </div>
    </Container>
  )
